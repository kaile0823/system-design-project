        ...
        <Dialog v-model:visible="userDialog" :style="{ width: '80%' }" header="User Details" :modal="true">
            <Form v-slot="$form" :resolver="resolver" :initialValues="initialValues" :validateOnValueUpdate="false"
                ...
                <InputGroup>
                    ...
                    <InputText v-model="address" name="address.address" placeholder="Address" />
                </InputGroup>
                ...
                <InputGroup>
                    ...
                    <Select v-model="selectedCounty" name="address.county" :options="counties" placeholder="Counties" fluid />

                    <InputGroupAddon>
                        <i class="pi pi-map"></i>
                    </InputGroupAddon>
                    <Select v-model="selectedDistrict" name="address.district" :options="districts" placeholder="District"
                        fluid />
                </InputGroup>
                <div class="grid">
